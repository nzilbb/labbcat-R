...
test_that("getFragmentAnnotationData works", {
    ...
    ## define subdirectory
    subdir <- "test-getFragmentAnnotationData"
    
    ## Get a list of data files
    image.files <- getFragmentAnnotationData(
        labbcat.url, results$Transcript,
        results$Target.word.start, results$Target.word.end,
        "mediapipe",
        path=subdir)
